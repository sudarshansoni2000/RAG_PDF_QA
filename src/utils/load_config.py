...
class LoadConfig:
    ...
    def __init__(self) -> None:
        ...
        with open(here("configs/app_config.yml")) as cfg:
            ...
            # Memory
            self.number_of_q_q_pairs = app_config["memory"]["number_of_q_a_pairs"]
    ...
    def load_openai_cfg(self):
        ...
        openai.api_key = "sk-proj-IVXbI5hXcFy2jEYtFCtnT3BlbkFJyz1yE5aKsYq7uTBLwXgM" #"sk-proj-a7JM7n1jmXuOah8BwrgTT3BlbkFJhbBBrauTbf9cglyOQFfx"

    def create_directory(self,directory_path :str):
        """
        Create a directory if it does not exists 
        parameters:
        directroy_path(str): The path of the directory to be created.
        """
