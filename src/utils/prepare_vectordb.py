...
class PrepareVectorDB:
    """
    A class for preparing and saving a vectorDB suing OpenAI Embeddings
    ...
    def __init__(
        ...
        embedding_model_engine (Str): The engine for OpenAI embeddings.
        chunk_size (int) : The Size of the chunks for document processing.
        chunk overlap(int): the overlap between chunks 
        """
    ...
    def __chunk_documents(self , docs: List) -> List:
        ...
        """
        Chunk the loaded documents usint he specified text splitter 
    ...
    def prepare_and_save_vectordb(self):
        ...
        """
        Load , chunk and create a vector db with open ai embeddings and save it .
        ...
        print("Number of vector in vector db ",vectordb._collection.count(), "\n\n")
